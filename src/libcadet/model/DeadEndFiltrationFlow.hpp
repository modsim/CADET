...
/**
* @file
* Defines the DeadEndFiltrationFlow model as a unit operation.
*/

#ifndef LIBCADET_DEADENDFILTRATIONFLOW_HPP_
#define LIBCADET_DEADENDFILTRATIONFLOW_HPP_
 ...
 */
class DeadEndFiltrationFlow : public UnitOperationBase
{
public:

	DeadEndFiltrationFlow(UnitOpIdx unitOpIdx);
	virtual ~DeadEndFiltrationFlow() CADET_NOEXCEPT;
	...
	static const char* identifier() { return "DEADENDFILTRATIONFLOW"; } // ToDo : abbreviate DEFF?
...
#endif  // LIBCADET_DEADENDFILTRATIONFLOW_HPP_
