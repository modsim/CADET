...
protected:
	...
	parts::TwoDimensionalConvectionDispersionOperator
	...
	public:
		...
		{
			return static_cast<int>(_disc.nComp) * static_cast<int>(_disc.nRad);
		}
		inline int strideColRadialCell() const CADET_NOEXCEPT
		{
		...
		{
			return static_cast<int>(_disc.nComp) * static_cast<int>(_disc.nParType);
		}
		...
		{
			return _disc.nComp * _disc.nCol * _disc.nRad + offsetC();
		}
		...
		{
			return offsetJf() + pti.value * _disc.nCol * _disc.nComp * _disc.nRad;
		}
		...
		{
			return data[offsetC() + comp + col * strideColAxialCell() + rad * strideColRadialCell()];
		}
		template <typename real_t>
	...
	{
	public:
		Exporter(const Discretization& disc, const GeneralRateModel2D& model, double const* data)
		...
		{
			return _disc.nComp * _disc.nCol * _disc.nRad;
		}
		...
		{
			return _disc.nComp * _disc.nCol * _disc.nRad * _disc.nParType;
		}
